...
function onDataLoaded(dObj) {
    ...
    //console.log(dObj);
        ...
        board = dY.graph.addBoard("#dy-canvas", { inWidth: 1700, inHeight: 3300, margin: 20 });
...
//radial gradient for the path
   ...
   .attr("y2", "100%");
            ...
            ctrdGrp.append("text")
                .text( dateStr )
                .style("text-anchor", "middle")
                .attr("transform", "rotate(90) translate(0, " + (-disp/1.6) + ")") // rotate to horizontal, translate to bottom of board 
                .attr("class", "daylabel");
